  ...
  <div class="mt-6 sm:mt-8 md:mt-10">
    <section class="flex flex-col">
      ...
      <div class="flex flex-col sm:flex-row-reverse">
        ...
        />
        <p class="mt-3 mr-14 text-lg">
          Hi! I'm Hui Beom, a software developer from South Korea.<br><br>

          I'm born in 1997 and studied computer science in college. I like learning about tech, browsing reddit posts and playing musical instruments in my free time.
        </p>
      </div>
    </section>
    <section class="flex flex-col mt-10">
      ...
      <ul class="mt-2 text-lg">
        <li>Learning to play bass!</li>
        <li>Tweaking this website</li>
        <li>Preparing for CKAD exam</li>
      </ul>
    </section>
      ...
      <UCollapsible class="flex flex-col gap-2">
        ...
        <template #content>
          <TheAlert class="mt-3">
            ...
            Frequently used skills are highlighted with <span class="text-neutral-100">brighter</span> background.
          </TheAlert>
          <div class="mt-6">
            <h4>Languages</h4>
