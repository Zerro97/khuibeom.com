...
<template>
  <div class="flex items-center w-full mt-5 overflow-auto border rounded bg-neutral-800 border-neutral-700">
    ...
    <input
      v-model="searchWord"
      class="w-full min-w-[240px] h-full px-4 py-2 shrink bg-neutral-800"
      type="text"
      placeholder="Search"
    >
  </div>
