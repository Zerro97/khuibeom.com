...
<template>
  <div class="flex flex-col justify-between p-4 border rounded border-zinc-700">
    ...
    <div class="flex flex-wrap mt-4 gap-x-4 gap-y-4">
      <nuxt-img :src="image" :alt="title" provider="cloudinary" width="400px" height="200px" loading="lazy" class="object-cover object-top w-full rounded aspect-[4/2]" />
